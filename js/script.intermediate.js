const cardsMovie = [{
    'name': 'fightclub',
    'img': 'img/filmler/fightclub.jpg',
},
{
    'name': 'jackspar',
    'img': 'img/filmler/jackspar.jpg',
},
{
    'name': 'joker',
    'img': 'img/filmler/joker.jpg',
},
{
    'name': 'keanask',
    'img': 'img/filmler/keanask.jpg',
},
{
    'name': 'mask.jpg',
    'img': 'img/filmler/mask.jpg',
},
{
    'name': 'mcakoy',
    'img': 'img/filmler/mcakoy.jpg',
}, 
{
    'name': 'scary',
    'img': 'img/filmler/scary.jpg',
},
{
    'name': 'tom',
    'img': 'img/filmler/tom.jpg',
},
{
    'name': 'vforven',
    'img': 'img/filmler/vforven.jpg',
}
];


//random düzen 
const gameGrid = cardsMovie
    .concat(cardsMovie)
...
const match = () => {
    ...
    // tümü dogru ise 
    if (trueCount==cardsMovie.length) {
        winGame();
