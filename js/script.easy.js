const cardsMarvel = [{
        'name': 'blackpan',
        'img': 'img/marvel/blackpan.jpg',
    },
    {
        'name': 'deadpol',
        'img': 'img/marvel/deadpol.jpg',
    },
    {
        'name': 'drstrange',
        'img': 'img/marvel/drstrange.jpg',
    },
    {
        'name': 'groot',
        'img': 'img/marvel/groot.jpg',
    },
    {
        'name': 'ironman',
        'img': 'img/marvel/ironman.jpg',
    },
    {
        'name': 'venom',
        'img': 'img/marvel/venom.jpg',
    }
];


//random düzen 
const gameGrid = cardsMarvel
    .concat(cardsMarvel)
...
const match = () => {
    ...
    // tümü dogru ise 
    if (trueCount==cardsMarvel.length) {
        winGame();
...
//her 1 saniyede timer çagır ve ekrana yazdır
